...
const getOneUserInfo = (userId) => {
  ...
  const createUserInfo = (userInfo) => {
    return new Promise((resolve, reject) => {
      ...
      water,physicalActivity,
      reasonMusclesIncrease,reasonMusclesDefinition,reasonWeightloss, reasonHealth,
      levelPreferred,areaPreferred,
      timeAvailability,gymAccess,expStrenght,expCardiovascular,areaAbdominals,
      areaArms,areaCardio,areaBack,areaChest,trainingDays,
      trainingHours,constantTraining,sleepingHours,productNothing,productCreatina,
      productPreTraining,productProtein,productOthers,energy1,energy2,
      ...
      connection.query(sql, [userInfo.idUser, userInfo.age, userInfo.height, userInfo.weight, userInfo.gender,
                            ...
                            userInfo.water, userInfo.physicalActivity, 
                            userInfo.reasonMusclesIncrease,userInfo.reasonMusclesDefinition,userInfo.reasonWeightloss, userInfo.reasonHealth, 
                            userInfo.levelPreferred, userInfo.areaPreferred, 
                            userInfo.timeAvailability, userInfo.gymAccess, userInfo.expStrenght, userInfo.expCardiovascular, userInfo.areaAbdominals,
                            userInfo.areaArms, userInfo.areaCardio, userInfo.areaBack, userInfo.areaChest, userInfo.trainingDays,
                            userInfo.trainingHours,userInfo.constantTraining,userInfo.sleepingHours,userInfo.productNothing,userInfo.productCreatina,
                            userInfo.productPreTraining,userInfo.productProtein,userInfo.productOthers,userInfo.energy1,userInfo.energy2
                          ], (error, results) => {
        if (error) {
