...
const getOneUserInfo = (userId) => {
  ...
  const createUserInfo = (userInfo) => {
    return new Promise((resolve, reject) => {
      ...
      water,physicalActivity,trainingReason,levelPreferred,areaPreferred,
      ...
      connection.query(sql, [userInfo.idUser, userInfo.age, userInfo.height, userInfo.weight, userInfo.gender,
                            ...
                            userInfo.water, userInfo.physicalActivity, userInfo.trainingReason, userInfo.levelPreferred, userInfo.areaPreferred, 
